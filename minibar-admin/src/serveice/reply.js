...
export function getById(id) {
  return get('/api/v1/admin/reply/one',{
    params: { id }
  })
}
...
export function postCreate(data) {
  return post('/api/v1/admin/reply/create',data)
}
...
export function postUpdate(id,data) {
  return post(`/api/v1/admin/reply/update/${id}`,data)
}
...
export function postDel(id) {
  return post(`/api/v1/admin/reply/del/${id}`)
}
